...
5. `N8N_WEBHOOK_URL_MARKETINGBILDER_PROMPT_ONLY`
6. `N8N_WEBHOOK_URL_MARKETINGBILDER_WITH_IMAGES`
7. `N8N_WEBHOOK_URL_MARKETINGBILDER_EDIT_IMAGE`
8. `N8N_WEBHOOK_URL_WEEKLY_SOCIAL_MEDIA_PACKAGE`
9. `N8N_WEBHOOK_URL_PRODUCT_VIDEO`
10. `N8N_WEBHOOK_URL_PRODUCT_DATA`
11. `N8N_WEBHOOK_IMAGES_TO_VIDEO_GENERATION`
12. `NEXT_PUBLIC_N8N_WEBHOOK_URL_BUSINESS_WEBSITE_DNA`
